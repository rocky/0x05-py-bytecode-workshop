...
1. Disassemble or decompile the `07/five$py.class` which was created in Jython 2.7.4. Hint: use a java decompiler.
...
1. Extend Pylingual so that it handles one of the PyPy variants for 3.6-3.11. Pydisasm from xdis already supports PyPy. I've mentioned this to the pylingual folks, and they expressed interest.
...
1. Investigate writing a decompiler for Ethereum EVM to Solidity. There are disassemblers for EVM. There is also a pyenv for switching Solidity compilations. I've mentioned this to the pylingual folks, and they expressed interest.
